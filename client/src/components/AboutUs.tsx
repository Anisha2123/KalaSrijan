  ...
  return (
    <div ref={secRef}>
      <style>{`
        ...
        .mtm-section { background:#fff8f4; font-family:'DM Sans',sans-serif; position:relative; overflow:hidden; padding:90px 0 80px; }
        ...
        .mtm-left-anim{animation:fadeLeft 1s ease 0.2s both}
        .mtm-right-anim{animation:fadeRight 1s ease 0.35s both}
        .mtm-cred-item{transition:transform 0.2s,background 0.2s,border-color 0.2s}
        .mtm-cred-item:hover{transform:translateX(5px);background:rgba(205,44,88,0.07)!important;border-color:rgba(205,44,88,0.35)!important}
        .mtm-stat-card{transition:transform 0.25s,box-shadow 0.25s,background 0.25s,border-color 0.25s}
        .mtm-stat-card:hover{transform:translateY(-5px);box-shadow:0 14px 36px rgba(205,44,88,0.14)!important;background:rgba(205,44,88,0.07)!important;border-color:rgba(205,44,88,0.32)!important}
        .mtm-btn-main{transition:transform 0.22s,box-shadow 0.22s,background 0.22s}
        .mtm-btn-main:hover{background:#b82350!important;transform:translateY(-2px);box-shadow:0 14px 38px rgba(205,44,88,0.42)!important}
        .mtm-toggle-btn{transition:opacity 0.2s}.mtm-toggle-btn:hover{opacity:0.65}
        .mtm-tl-dot{transition:background 0.2s,border-color 0.2s}
        .mtm-tl-row:hover .mtm-tl-dot{background:rgba(205,44,88,0.10)!important;border-color:rgba(205,44,88,0.45)!important}
        .mtm-photo-frame-deco{transition:transform 0.4s}
        .mtm-photo-outer:hover .mtm-photo-frame-deco{transform:translate(5px,5px)!important}
      `}</style>
      ...
      <div className="mtm-section">
        ...
        <div style={{position:"absolute",top:60,right:20,fontFamily:"'Cormorant Garamond',serif",fontSize:"16rem",fontWeight:600,color:"rgba(205,44,88,0.04)",lineHeight:1,pointerEvents:"none",zIndex:0,userSelect:"none"}}>"</div>
        ...
        <div style={{maxWidth:1180,margin:"0 auto",padding:"0 36px",position:"relative",zIndex:1}}>
          ...
          {inView && (
            <div className="mtm-eyebrow-anim" style={{display:"flex",alignItems:"center",gap:14,marginBottom:60}}>
              <div style={{width:56,height:1,background:"linear-gradient(90deg,#CD2C58,transparent)"}}/>
              ...
              <div style={{width:56,height:1,background:"linear-gradient(270deg,#CD2C58,transparent)"}}/>
            </div>
          )}

          {/* Grid */}
          <div style={{display:"grid",gridTemplateColumns:"1fr 1.15fr",gap:68,alignItems:"start"}}>

            {/* LEFT */}
            {inView && (
              <div className="mtm-left-anim">
                <div className="mtm-photo-outer" style={{position:"relative",display:"block",maxWidth:380}}>
                  ...
                  {/* Photo */}
                  <div style={{position:"relative",zIndex:1,width:"100%",aspectRatio:"3/4",borderRadius:"28px 8px 28px 8px",background:"linear-gradient(155deg,#FFC69D 0%,#E06B80 55%,#CD2C58 100%)",overflow:"hidden",boxShadow:"0 32px 80px rgba(205,44,88,0.22),0 8px 24px rgba(224,107,128,0.14)",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:10}}>
                    {/* Replace with <img src="..." alt="Suman Jain" style={{width:"100%",height:"100%",objectFit:"cover"}}/> */}
                    <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"6rem",fontWeight:300,color:"rgba(255,255,255,0.90)",lineHeight:1,textShadow:"0 4px 20px rgba(205,44,88,0.22)"}}>सुमन</div>
                  ...
                  {/* Badge */}
                  <div style={{position:"absolute",bottom:-16,right:-16,zIndex:2,background:"#fff",borderRadius:18,padding:"13px 18px",boxShadow:"0 10px 40px rgba(205,44,88,0.16)",border:"1px solid rgba(255,255,255,0.90)",display:"flex",alignItems:"center",gap:12,animation:"badgeFloat 6s ease-in-out infinite"}}>
                    <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"2rem",fontWeight:600,color:"#CD2C58",lineHeight:1}}><CountUp target="5000+" /></div>
                    <div style={{fontSize:"0.70rem",color:"#7a4a55",lineHeight:1.45,maxWidth:70,fontFamily:"'DM Sans',sans-serif"}}>Happy Students & Counting</div>
                  </div>
                </div>
            ...
            {inView && (
              <div className="mtm-right-anim">
                <h2 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"clamp(2.3rem,3.8vw,4rem)",fontWeight:300,lineHeight:1.08,color:"#2a1018",marginBottom:20}}>
