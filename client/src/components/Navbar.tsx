...
const NAV_LINKS = [
  ...
  },
  {
    ...
    sub: [
      ...
      { label: "Why Choose Us",   href: "#why",   desc: "Experience · Trust · Creativity" },
  ...
  },
  {
    ...
    href: "#classes",
    sub: [
      { label: "Painting",       href: "#classes", desc: "8 styles · ₹3K–₹5K" },
      { label: "Stitching",      href: "#classes", desc: "3 diploma courses" },
      { label: "Clay & Paper",   href: "#classes", desc: "Modeling & craft modules" },
      { label: "Resin & Candle", href: "#classes", desc: "2-day workshops" },
      { label: "Rangoli & More", href: "#classes", desc: "Cultural art forms" },
    ],
  },
  {
    label: "Services",
    href: "#services",
    sub: [
      { label: "Hand Painting",    href: "#services", desc: "Custom art on any surface" },
      { label: "Fancy Dress",      href: "#services", desc: "Design & costume craft" },
      { label: "Wedding Hampers",  href: "#services", desc: "Bespoke gift packaging" },
      { label: "School Projects",  href: "#services", desc: "From ₹300" },
    ],
  },
  {
    label: "Gallery",
